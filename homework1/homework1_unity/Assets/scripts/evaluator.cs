...
public class evaluator : MonoBehaviour {
    ...
    private const float target_area = 0.02f; //area where ball is considered in the target zone as a percent of the beam length
    private const float stable_time = 4f; //time ball must be in area to be considered stable
    private const float stable_speed = 0.06f;//max speed of ball to be considered stable
