...
sess = ort.InferenceSession("models/model.onnx",providers=["CUDAExecutionProvider"])
...
# Depth map: normalize to 0-255 for visualization
    depth_img = cv2.normalize(predicted_depth, None, 0, 255, cv2.NORM_MINMAX).astype(np.uint8)
